...
-- Economy/Printers/Chair/AutoCollect endpoints (flat under Remotes)
...
ensureInstance(Remotes, "RemoteFunction", "UpgradeChair")
...
assertClass(Remotes, "UpgradeChair", "RemoteFunction")
...
-- Gameplay services
require(Services:WaitForChild("ChairService"))
