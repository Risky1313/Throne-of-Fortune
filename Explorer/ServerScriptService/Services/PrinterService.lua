...
local function ThronesMult(profileData)
	local tier = 0
	if profileData.Thrones and type(profileData.Thrones.Tier) == "number" then
		tier = profileData.Thrones.Tier
	end
	local cfg = ThronesCfg[tier] or ThronesCfg[0]
